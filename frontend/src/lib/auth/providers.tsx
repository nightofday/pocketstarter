...
// Currently enabled providers - easily configure which ones to show
export const enabledProviders = ['google'] // Add 'github', 'discord', etc. to enable them

// Get list of enabled provider configurations
export const getEnabledProviders = (): OAuthProvider[] => {
  return enabledProviders
    .map(name => oauthProviders[name])
